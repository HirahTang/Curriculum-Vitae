...
\\
{\bf Design a database for an Irish retail company}

Designing the ER Diagram, using Oracle Data Modeler, depends on the applying scenario.

Assign the attributes, additional indexes and other physical database features in the Physical Model.
